...
@Command(name = "video-cli", description = "...", mixinStandardHelpOptions = true, 
		subcommands = {GetVideosCommand.class, AddVideoCommand.class, GetVideoCommand.class,
						GetAuthorsVideosCommand.class, LikeVideo.class, DislikeVideo.class, 
						AddVideoWatcherCommand.class, GetVideoWatchersCommand.class, 
						GetUsersCommand.class, AddUserCommand.class, GetUserCommand.class,
						GetHashtag.class, GetHashtags.class, AddHashtag.class, 
						GetVideoHashtagsCommand.class, GetVideoAuthor.class, AddVideoHashtag.class, 
						GetHashtagsVideos.class, HeartBeatCommand.class})
